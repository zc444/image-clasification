...
int main( int argc, char** argv )
{
  ...
  if ( !__n || ( __n ==  2 ) ) test_case_2bin_add<int>(2,&mk_int);
  if ( !__n || ( __n ==  3 ) ) test_case_duplicate_add<int>(3,&mk_int);
  if ( !__n || ( __n ==  4 ) ) test_case_empty_bin<int>(4,&mk_int);
  if ( !__n || ( __n ==  5 ) ) test_case_construct_empty<int>(5,&mk_int);
  if ( !__n || ( __n ==  6 ) ) test_case_find_simple<int>(6,&mk_int);
  if ( !__n || ( __n ==  7 ) ) test_case_find_empty<int>(7,&mk_int);
  if ( !__n || ( __n ==  8 ) ) test_case_find_closest<int>(8,&mk_int);
  if ( !__n || ( __n ==  9 ) ) test_case_copy_v1<int>(9,&mk_int);
  if ( !__n || ( __n == 10 ) ) test_case_copy_v2<int>(10,&mk_int);
  if ( !__n || ( __n == 11 ) ) test_case_copy_empty<int>(11,&mk_int);
  if ( !__n || ( __n == 12 ) ) test_case_assignment<int>(12,&mk_int);
  if ( !__n || ( __n == 13 ) ) test_case_assignment_diff_nbins<int>(13,&mk_int);
